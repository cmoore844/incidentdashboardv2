...
const columns = [
  ...
  { field: 'opened_at', headerName: 'DATE OPENED', width: 140 },
  { field: 'assignment_group', headerName: 'ASSIGNED GROUP', width: 140 }
];
...
export default function DataTable() {
  ...
  return (
    <div style={{ height: 600, width: 880}}>
      <DataGrid
        rows={rows}
        columns={columns}
        initialState={{
